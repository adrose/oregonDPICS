...
# pdf("allIntCLUPNoIntra.pdf")
# for(z in unique(brms.datAll$X1)){
#   tmp.plot <- ggplot(test[which(test$X1==z & test$Block==3),], aes(y=stayLength, x=countVar, color=currentState, fill=currentState)) +
#     geom_point() +

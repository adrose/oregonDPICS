...
## Now try the cumulative summation from previous comply model here
# coxphmod <- coxph(Surv(currentSesh, time2 = Time_Relative_sf, event = Comply) ~ (state1CumSum+state2CumSum+state3CumSum+state4CumSum+state5CumSum)^2+complyCount+CDINUM, 
#                   ties=c("efron"),data = out.surv.caps)
# summary(coxphmod)
# ## Now compare the comply count predictor within individual
# coxphmodInt <- coxme(Surv(currentSesh, time2 = Time_Relative_sf, event = Comply) ~ 1 + (1|participant), 
#                   ties=c("efron"),data = out.surv.caps)
# coxphmodSlo <- coxme(Surv(currentSesh, time2 = Time_Relative_sf, event = Comply) ~ 1 + (complyCount|participant), 
#                   ties=c("efron"),data = out.surv.caps)
# ## Now build up the model here
# coxphmodFul <- coxme(Surv(currentSesh, time2 = Time_Relative_sf, event = Comply) ~ 1+(state1CumSum+state2CumSum+state3CumSum+state4CumSum+state5CumSum)^2+complyCount+CDINUM + (1 + complyCount|participant), 
#                   ties=c("efron"),data = out.surv.caps)
# coxphmodFul2 <- coxme(Surv(currentSesh, time2 = Time_Relative_sf, event = Comply) ~ 1+(state1CumSum+state2CumSum+state3CumSum+state4CumSum+state5CumSum)^2+complyCount+CDINUM +(1+complyCount|participant)+(state1CumSum|participant), 
#                      ties=c("efron"),data = out.surv.caps)
## Scaled down mixed effects model here
# coxphmodFul2 <- coxme(Surv(currentSesh,time2=Time_Relative_sf,event=Comply) ~ state1CumSum+(1+state1CumSum|participant), 
#                       ties=c("efron"),data = out.surv.caps)
#pairs(ranef(coxphmodFul2)$participant)
...
comply.glmer1 <- glmer(Comply ~ (comSpecific_Behavior_Description + comSpecific_Direct_Command_NO + 
                        ...
                        comSpecific_Reflection + comSpecific_Unlabeled_Praise + state5CumSum) + (1|participant), data = logit.dat,family = binomial)
comply.glmer2 <- glmer(Comply ~ (nonSpecific_Behavior_Description + nonSpecific_Direct_Command_NO + nonSpecific_Indirect_Command_NO + nonSpecific_Labeled_Praise + nonSpecific_Negative_Talk + nonSpecific_Neutral_Talk + nonSpecific_Question +
                         nonSpecific_Reflection + nonSpecific_Unlabeled_Praise + state5CumSumTotal) + (1|participant), data = logit.dat,family = binomial)
comply.glmer3 <- glmer(Comply ~ (nonSpecific_Behavior_Description + nonSpecific_Direct_Command_NO + nonSpecific_Indirect_Command_NO + nonSpecific_Labeled_Praise + 
...
comply.glmer4 <- glmer(Comply ~    nonSpecific_Behavior_Description + nonSpecific_Behavior_Description:timeFromLast_Behavior_Description +
                                   ...
                                   nonSpecific_Indirect_Command_NO +  nonSpecific_Indirect_Command_NO:timeFromLast_Indirect_Command_NO +
                                   nonSpecific_Labeled_Praise +       nonSpecific_Labeled_Praise:timeFromLast_Labeled_Praise +
                                   nonSpecific_Negative_Talk +        nonSpecific_Negative_Talk:timeFromLast_Negative_Talk +
                                   nonSpecific_Neutral_Talk +         nonSpecific_Neutral_Talk:timeFromLast_Neutral_Talk +
                                   nonSpecific_Question +             nonSpecific_Question:timeFromLast_Question +
...
visreg(comply.glmer4, "nonSpecific_Behavior_Description")
visreg(comply.glmer4, "nonSpecific_Indirect_Command_NO")
visreg(comply.glmer4, "nonSpecific_Neutral_Talk")
visreg(comply.glmer4, "nonSpecific_Reflection")
visreg(comply.glmer4, "nonSpecific_Unlabeled_Praise")
visreg(comply.glmer4, "state5CumSumTotal")
visreg(comply.glmer4, "nonSpecific_Behavior_Description", "timeFromLast_Behavior_Description")
visreg(comply.glmer4, "nonSpecific_Indirect_Command_NO", "timeFromLast_Indirect_Command_NO")
visreg(comply.glmer4, "nonSpecific_Neutral_Talk", "timeFromLast_Neutral_Talk")
visreg(comply.glmer4, "nonSpecific_Unlabeled_Praise", "timeFromLast_Unlabeled_Praise")
visreg(comply.glmer4, "state5CumSumTotal", "timeFromLastState_5")
summary(comply.glmer4)

comply.glmer5 <- glmer(Comply ~ nonSpecific_Behavior_Description +
                         nonSpecific_Direct_Command_NO +   
                         nonSpecific_Indirect_Command_NO + 
                         nonSpecific_Labeled_Praise +      
                         nonSpecific_Negative_Talk +       
                         nonSpecific_Neutral_Talk +        
                         nonSpecific_Question +            
                         nonSpecific_Reflection +          
                         nonSpecific_Unlabeled_Praise +
                         comSpecific_Behavior_Description + nonSpecific_Behavior_Description:timeFromLast_Behavior_Description +
                         comSpecific_Direct_Command_NO + nonSpecific_Direct_Command_NO:timeFromLast_Direct_Command_NO +
                         comSpecific_Indirect_Command_NO + nonSpecific_Indirect_Command_NO:timeFromLast_Indirect_Command_NO +
                         comSpecific_Labeled_Praise + nonSpecific_Labeled_Praise:timeFromLast_Labeled_Praise +
                         comSpecific_Negative_Talk + nonSpecific_Negative_Talk:timeFromLast_Negative_Talk +
                         comSpecific_Neutral_Talk + nonSpecific_Neutral_Talk:timeFromLast_Neutral_Talk +

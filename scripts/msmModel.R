...
covariates = list(
  ...
  "2-3" = ~ Block + Wave ,
  "2-4" = ~ Block + Wave ,
  "3-1" = ~ Block + Wave + Comply + NoOpportunity + Noncomply ,
  "3-2" = ~ Block + Wave + Comply + NoOpportunity + Noncomply ,
  "3-4" = ~ Block + Wave + Comply + NoOpportunity + Noncomply ,
  "4-1" = ~ Block + Wave ,
  "4-2" = ~ Block + Wave ,
  "4-3" = ~ Block + Wave )
model_allC <- msm(X4~X3, subject = X1, data = mod.dat2, center= FALSE, qmatrix=Q,exacttimes = TRUE,covariates = covariates,
                  gen.inits = FALSE, obstype = obstype,deathexact = deathexact, method = method, control = control)
